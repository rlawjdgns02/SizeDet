// Workaround for CUDA 11.1 incompatibility with newer Linux system headers
// Include basic types but prevent __int128 types
#ifdef __linux__
#include <asm/types.h>
// Define dummy types for __int128-based types that CUDA 11.1 doesn't support
typedef struct { __s64 a, b; } __s128 __attribute__((aligned(16)));
typedef struct { __u64 a, b; } __u128 __attribute__((aligned(16)));
#define _LINUX_TYPES_H  // Prevent linux/types.h from being included again
#endif
